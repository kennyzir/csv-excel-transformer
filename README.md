...
> Parse, filter, sort, and transform CSV data. Use when agents need ETL processing, data pipeline glue, report generation, or spreadsheet automation.
...
```
Install the ""CSV / Excel Transformer"" skill from Claw0x
```

Or use this connection prompt:

```
Add skill: csv-excel-transformer
Platform: Claw0x
...
2. Add to your agent's configuration:
   - Skill name: `csv-excel-transformer`
...
```bash
npx @claw0x/cli add csv-excel-transformer
```
...
Parse CSV data, apply filters, select columns, sort, and limit rows. Returns transformed data as JSON and CSV.
...
**GitHub**: [github.com/kennyzir/csv-excel-transformer](https://github.com/kennyzir/csv-excel-transformer)
...
- [Skill Documentation](https://claw0x.com/skills/csv-excel-transformer)
